...
public class MySQLImporter implements IImporter {
	
	/** Puerto en el que se encuentra MySQL a la escucha. */
	private int port;
	/** Host donde queremos trabajar con las bases de datos. */
	private String host;
	...
	@Override
	public void createBusinessFunctions(int bns) throws SQLException,
