...
public class GFormFile  extends GFormField
{
    ...
    protected int getWidthMin()
    {
       ...
       // return widthEdit(m_objViewBalancer.getAveCharWidth(),suma +/* mult * SH*/getLength());
        return widthEdit(m_objViewBalancer.getAveCharWidth(isHighlighted()), suma + mult * GConfigView.minimumLengthText );
    }
